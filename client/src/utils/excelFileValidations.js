const excelFileValidations = {}

excelFileValidations.validatePatrimonialCodes = (sheetData, setErrorMessage, setShowModalButton) => {
...
excelFileValidations.validateDateColumns = (sheetData, setErrorMessage, setShowModalButton) => {
    const headers = sheetData[0]; // Primera fila como encabezados
...
excelFileValidations.validateHeaderColumns = (sheetData, expectedColumns, setErrorMessage, setShowModalButton) => {
...
excelFileValidations.validateEmptyCells = (data, expectedColumns, setErrorMessage, setShowModalButton) => {
...
export default excelFileValidations;